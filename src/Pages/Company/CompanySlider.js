...
const CompanySlider = () => {
   ...
   const [data]=useState([
    {
        imgData:'https://trfastenings.blob.core.windows.net/sitecontent/8e5698e861c94c95952f5fe9d7777a61.png',
    ...
    {
        imgData:'https://trfastenings.blob.core.windows.net/sitecontent/4e547b11af8c4b4e8c865af05973aa08.png',
        head:'Who we supply',
    ...
    {
        imgData:'https://trfastenings.blob.core.windows.net/sitecontent/a9412ef56ce14112986cf01a8a9c39fa.png',
        head:'Our Services',
